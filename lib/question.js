        ...
        sqldb.beginTransaction((err, client, done) => {
            ...
            async.series([
                (callback) => {
                    ...
                    this._ensureVariantWithClient(client, question.id, instance_question_id, authn_user_id, authn_user_id, group_work, course_instance.id, course, options, require_open, (err, ret_variant) => {
                        if (ERR(err, callback)) return;
                        variant = ret_variant;
